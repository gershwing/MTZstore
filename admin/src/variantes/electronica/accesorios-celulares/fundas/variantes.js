/**
 * VARIANTES - Electrónica > Accesorios Celulares > Fundas
 *
...
export const variantes = {
  ...
  material: {
    tipo: "texto",
    opciones: ["Silicona suave", "TPU transparente", "Cuero sintético", "Fibra de carbono", "Policarbonato rígido", "Anti-shock rugged", "Billetera con tarjetero"]
  },

  acabado: {
    tipo: "texto",
    opciones: ["Liso", "Mate", "Brillante", "Glitter", "Texturizado", "Con impresión"]
  }
