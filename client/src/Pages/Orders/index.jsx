                  ...
                  <div key={order?._id} className="p-5 hover:bg-gray-50 transition-colors">
                    ...
                    {order?.pickupCode && (
                      <div className="mb-3 flex items-center gap-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2">
                        ...
                        <span className="text-xs text-blue-700">Codigo de recogida:</span>
                        <span className="font-mono font-bold text-sm text-blue-800 tracking-widest">{order.pickupCode}</span>
                      </div>
                    )}
