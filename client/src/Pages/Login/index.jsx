...
const Login = () => {
  ...
  const forgotPassword = () => {
    ...
    if (formFields.email === "") {
      ...
      context.alertBox("success", `Se envió el código OTP a ${formFields.email}`);
      ...
      <div className="container">
        <div className="card shadow-md w-full sm:w-[400px] m-auto rounded-md bg-white p-5 px-10">
          ...
          <form className="w-full mt-5" onSubmit={handleSubmit}>
            ...
            <a className="link cursor-pointer text-[14px] font-[600]" onClick={forgotPassword}>¿Olvidaste tu contraseña?</a>
            ...
            <p className="text-center">¿No tienes cuenta? <Link className="link text-[14px] font-[600] text-primary" to="/register"> Regístrate</Link></p>


            <p className="text-center font-[500]">O continúa con tu cuenta social</p>

            <Button className="flex gap-3 w-full !bg-[#f1f1f1] btn-lg !text-black"
              onClick={authWithGoogle}>
              <FcGoogle className="text-[20px]" /> Iniciar sesión con Google</Button>
