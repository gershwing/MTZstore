      ...
      <div className="container">
        <div className="card shadow-md w-full sm:w-[400px] m-auto rounded-md bg-white p-5 px-10">
          <h3 className="text-center text-[18px] text-black">
            Regístrate con una cuenta nueva
          </h3>
          ...
          <form className="w-full mt-5" onSubmit={handleSubmit}>
            ...
            <p className="text-center">¿Ya tienes una cuenta? <Link className="link text-[14px] font-[600] text-primary" to="/login"> Iniciar sesión</Link></p>
            ...
            <Button className="flex gap-3 w-full !bg-[#f1f1f1] btn-lg !text-black"
              ...
              <FcGoogle className="text-[20px]" /> Regístrate con Google</Button>
