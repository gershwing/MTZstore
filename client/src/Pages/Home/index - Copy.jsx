    ...
    <>
          ...
          <div className="flex items-center justify-between">
            <div className="leftSec">
              ...
              <p className="text-[14px] font-[400] mt-0 mb-0">
                No te pierdas las ofertas vigentes hasta finales de septiembre
              </p>
            </div>
          ...
          <div className="freeShipping  w-[80%] m-auto py-4 p-4 border-2 border-[#ff5252] flex items-center justify-between rounded-md mb-7">
            ...
            <div className="col2">
              <p className="mb-0 mt-0 font-[500]">
                ...
                Envío gratis ahora en tu primer pedido y más de Bs200
              </p>
            </div>

            <p className="font-bold text-[25px]">- Solo Bs200*</p>
          </div>
...

      {
        ...
        <section className="py-5 pb-8 pt-0 bg-white blogSection">
          <div className="container">
            <h2 className="text-[20px] font-[600] mb-4">Para el Blog</h2>
            <Swiper
              slidesPerView={4}
              spaceBetween={30}
              navigation={true}
