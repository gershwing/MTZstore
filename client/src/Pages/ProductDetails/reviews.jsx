...
export const Reviews = (props) => {
    ...
    const addReview = (e) => {
        ...
        if (reviews?.review !== "") {
            ...
            context.alertBox("error", "Por favor añade una reseña");
        }
    ...
    return (
        <div className="w-full productReviewsContainer">
            <h2 className="text-[16px] lg:text-[18px]">Preguntas y respuestas de clientes</h2>
            ...
            <div className="reviewForm bg-[#fafafa] p-4 rounded-md">
                <h2 className="text-[18px]">Agregar una reseña</h2>
