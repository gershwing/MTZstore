            ...
            <div className="bg-[#f1f1f1] p-2 w-full mb-4 rounded-md flex items-center justify-between sticky top-[135px] z-[99]">
              <div className="col1 flex items-center itemViewActions">
                ...
                <span className="text-[14px] hidden sm:block md:block lg:block font-[500] pl-3 text-[rgba(0,0,0,0.7)]">
                  Hay {productsData?.products?.length !== 0 ? productsData?.products?.length : 0}  productos.
                </span>
              </div>
              ...
              <div className="col2 ml-auto flex items-center justify-end gap-3 pr-4">
                ...
                >
                  <MenuItem
                    onClick={() => handleSortBy('name', 'asc', productsData, 'Nombre, A a Z')}
                  ...
                  <MenuItem
                    onClick={() => handleSortBy('name', 'desc', productsData, 'Nombre, Z a A')}
                    className="!text-[13px] !text-[#000] !capitalize"
                  >
                    Nombre, Z a A
                  </MenuItem>
                  ...
                  <MenuItem
                    onClick={() => handleSortBy('price', 'asc', productsData, 'Precio, de menor a mayor')}
                    className="!text-[13px] !text-[#000] !capitalize"
                  >
                  ...
                  <MenuItem
                    onClick={() => handleSortBy('price', 'desc', productsData, ' Precio, de mayor a menor')}
                    className="!text-[13px] !text-[#000] !capitalize"
                  >
