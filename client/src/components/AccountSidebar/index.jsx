    ...
    <div className="card bg-white shadow-md rounded-md sticky top-[160px]">
      ...
      <ul className="list-none pb-5 bg-[#f1f1f1] myAccountTabs">
        <li className="w-full">
          ...
          >
            <Button className="w-full !text-left !py-2 !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <FaRegUser className="text-[15px]" /> Mi Cuenta
            </Button>
          </NavLink>
        </li>
        ...
        <li className="w-full">
          ...
          >
            <Button className="w-full !text-left !py-2 !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <LuMapPin className="text-[18px]" /> Dirección
            </Button>
          </NavLink>
        </li>
        ...
        <li className="w-full">
          ...
          >
            <Button className="w-full !py-2 !text-left !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <IoMdHeartEmpty className="text-[17px]" /> Lista de deseos
            </Button>
          </NavLink>
        </li>
        ...
        <li className="w-full">
          ...
          >
            <Button className="w-full !py-2 !text-left !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <IoBagCheckOutline className="text-[17px]" /> Mis Pedidos
            </Button>
          </NavLink>
        </li>

        {/* Ser vendedor — solo si el usuario no tiene tienda */}
        {!context?.userData?.defaultStoreId &&
          (!context?.userData?.memberships || context?.userData?.memberships?.length === 0) && (
          <li className="w-full">
            <Button
              className="w-full !py-2 !text-left !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2"
              onClick={() => {
                context?.checkSellerApplication?.();
                context?.setShowSellerModal?.(true);
              }}
            >
              <HiOutlineBuildingStorefront className="text-[18px]" /> Ser vendedor
            </Button>
          </li>
        )}
        ...
        <li className="w-full">
          <Button className="w-full !py-2  !text-left !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2" onClick={logout}>
            <IoIosLogOut className="text-[18px]" /> Cerrar sesión
          </Button>
        </li>
      </ul>
    </div>
